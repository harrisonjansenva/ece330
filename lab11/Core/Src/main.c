...
char Message[] = {
				...
				CHAR_G, DASH, CHAR_B, CHAR_Y, CHAR_E, SPACE,CHAR_E,CHAR_C,CHAR_E,DASH,CHAR_3,CHAR_3,CHAR_0,CHAR_L,
				SPACE,SPACE,SPACE,SPACE,SPACE,SPACE,SPACE,SPACE,SPACE,SPACE
};
...
int main(void)
{
  ...
  RCC->AHB1ENR |= RCC_AHB1ENR_CRCEN;	//enable CRC calculator
  ...
  *******************************************************************************************************/
  ...
  while (1)
  {
	  ...
	  //********* Reset CRC value ********************
	  CRC->CR = CRC_CR_RESET;	//reset CRC value

	  //********* Calculate CRC **********************
	  for (i = 0; i < Message_Length; i++) {
		  CRC->DR = Message[i];	//feed message into crc data register
	  }
